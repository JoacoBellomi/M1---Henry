...
//OBJETIVO: cacheFunction actúe como memoria CACHÉ (que recuerde) 
//USANDO un closure 
//
/*
const cb = function(x) {
...
/*
  ...
  bajos, respectivamente). Las funciones obtenidas deberían recibir solamente un argumento - la cadena de
  texto - ya que los otros argumentos habrán sido "bindeados". 
*/
...
let textoGuiones = crearCadena.bind('H', '-', '-');
let textoUnderscore = crearCadena.bind('Cualquiercosa', '_', '_');
